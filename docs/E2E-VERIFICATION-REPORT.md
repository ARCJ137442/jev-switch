...
> **历史验证说明（2026-09-27）：**本文保留的是早期 v0.5.1 名义下的点时验证记录，不代表当前正式发布版本或当前构建的验收结果。当前正式发行版为 [v0.1.0](https://github.com/ARCJ137442/jev-switch/releases/tag/v0.1.0)；现行范围和阶段证据以 [README](../README.md) 与[入口网关认知对齐与实施计划](design/ENDPOINT-GATEWAY-ALIGNMENT-PLAN.md) 为准。下文测试结论仅适用于原记录时的代码、环境和检查范围。
