...
/**
 * Model 选择器 — 等宽字体 + 极简标签 + TeamSense 面板头（A3 caption 右挂）。
      ...
      <div className="px-4 py-3">
        <label className="flex items-center gap-3">
          ...
          <select
            ...
            className="h-8 flex-1 appearance-none border border-border bg-soft px-3 font-mono text-[13px] text-ink tabular"
